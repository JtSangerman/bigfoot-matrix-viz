...
namespace Maze
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			MazeHolder curMaze = new MazeHolder(rows, cols);
	...
	public class MazeHolder
	{
		...
		public MazeHolder(int rows, int cols)
		{
			...
			MazeStack cornMaze = new MazeStack(rRow, rCol, 2 * rows + 1, 2 * cols + 1, scale);
	...
	public class MazeStack
	{
		...
		public MazeStack(int row, int col, int cornRow, int cornCol, int scale)
		{
